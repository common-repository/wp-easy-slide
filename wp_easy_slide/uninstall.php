...
//This plugin creates its own database tables to save the post ids for the posts and pages added to WP Easy Slide. When the plugin will be deleted, the database tables will also get deleted.
