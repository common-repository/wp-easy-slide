...
<div id="poststuff" class="metabox-holder has-right-sidebar" style="float:right;width:30%;"> 
   <div id="side-info-column" class="inner-sidebar"> 
			<div class="postbox"> 
			  ...
			  <div class="inside">
                <ul>
                <li><a href="http://www.dallasprowebdesigners.com" title="WP Easy Slide Homepage" >Plugin Homepage</a></li>
                <li><a href="http://www.dallasprowebdesigners.com" title="Visit Dallas Pro Web Design Studios" >Plugin Parent Site</a></li>
                <li><a href="http://www.dallasprowebdesigners.com" title="Support Forum for Wp Easy Slide" >Support Forum</a></li>
                </ul> 
              </div> 
			</div> 
     </div>
...
<td><input name="smooth_slider_options[shortcode]" type="checkbox" value="1" <?php checked('1', $smooth_slider['shortcode']); ?>  />&nbsp;check this if you want to use Wp Easy Slide Shortcode i.e [WP Easy Slide]</td>
</tr>
...
<tr valign="top">
<th scope="row">Multiple Slide Feature</th>
...
<input name="smooth_slider_options[multiple_sliders]" type="checkbox" id="smooth_slider_multiple" value="1" <?php checked("1", $smooth_slider['multiple_sliders']); ?> /> 
 Enable Multiple Slide Function on Edit Post/Page</label></td>
</tr>
