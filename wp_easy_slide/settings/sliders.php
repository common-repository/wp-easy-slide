<?php // This function displays the page content for the Wp Easy Slide Options submenu
...
<a href="<?php echo $url; ?>" title="Settings Page for WP Easy Slide where you can change the color, font etc. for the sliders">Go to Smooth Slider Settings page</a>
   ...
   <div id="side-info-column" class="inner-sidebar" style="float:left;"> 
			<div class="postbox"> 
			  ...
			  <div class="inside">
                ...
                <li><a href="http://www.dallasprowebdesigners.com" title="Visit Pro Web Design Studios" >Plugin Parent Site</a></li>
                <li><a href="http://www.dallasprowebdesigners.com" title="Support Forum for Smooth Slider" >Support Forum</a></li>
                </ul> 
              </div> 
			</div> 
     </div>
