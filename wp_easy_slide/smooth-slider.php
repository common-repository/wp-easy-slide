...
*/
//Please visit Plugin page http://www.dallasprowebdesigners.com/free-wordpress-plugins.html for Changelog
//on activation
...
function smooth_slider_old_custom_box() {
  ...
  echo '<div class="dbx-h-andle-wrapper"><h3 class="dbx-handle">' . 
        __( 'WP Easy Slide', 'smooth-slider' ) . "</h3></div>";   
...
?>
	...
	<noscript><strong>This page is having a slideshow that uses Javascript. Your browser either doesn't support Javascript or you have it turned off. To see this page as it is meant to appear please use a Javascript enabled browser.</strong></noscript>
		  ...
		  <?php } ?>
				<div class="sldrlink"><a href="http://www.dallasprowebdesigners.com/free-wordpress-plugins.html" target="_blank">Wordpress Web Design</a></div>
...
if(!empty($slider_id)){
	...
	<noscript><strong>This page is having a slideshow that uses Javascript. Your browser either doesn\'t support Javascript or you have it turned off. To see this page as it is meant to appear please use a Javascript enabled browser.</strong></noscript>
		...
		$slider_html=$slider_html.'<div class="sldrlink"><a href="http://www.dallasprowebdesigners.com/free-wordpress-plugins.html" target="_blank">Wordpress Web Design</a></div>
			</div>
		</div>';
  } //end of not empty slider_id condition
  return $slider_html;
